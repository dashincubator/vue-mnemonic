            ...
            keyup: function (e) {
                ...
                if (value) {
                    ...
                    if (e.keyCode === 9) {
                        ...
                        if (this.suggestions.length < (this.index.suggestion + 1) || this.index.suggestion < 0) {
                            this.index.suggestion = 0;
                        }
                ...
                else if (![13, 32].includes(e.keyCode) && !value.includes(" ") && !value.includes(",")) {
                    return;
                }

                if (!this.whitelist.includes(value)) {
                    if (mnemonic.length === 1 && (value.includes(' ') || value.includes(','))) {
